...
//           >
//             <m.div className="flex justify-center items-center gap-4 mb-6 bg-red-6">
//               {/* Icon with flex and align-self to center precisely */}
//               <GitBranch className="w-12 h-12 text-cyan-400 flex-shrink-0 self-center" />
...
//             className="relative"
//           >
//             <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-cyan-500 via-blue-500 to-teal-500 opacity-30"></div>
...
//                   className={`relative mb-20 md:mb-32 flex items-stretch gap-8 md:gap-12 ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'}`}
//                 >
//                   {/* Content Card */}
//                   <div className={`flex-1 ${isEven ? 'md:pr-16' : 'md:pl-16'} pl-20 md:pl-0`}>
//                     <m.div
//                       whileHover={{ scale: 1.02, y: -5 }}
//                       transition={{ duration: 0.3 }}
//                       className={`bg-gray-800/50 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-8 shadow-2xl ${item.glowColor} hover:shadow-2xl transition-all duration-300 h-full`}
//                     >
...
//                             className="px-3 py-1 text-sm bg-gray-700/50 border border-gray-600/50 rounded-lg text-gray-200 hover:bg-gray-600/50 transition-colors"
//                           >
//                             {skill}
//                           </m.span>
//                         ))}
...
//                       className={`relative w-32 h-32 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center shadow-2xl`}
//                     >
...
//                     className={`absolute left-8 md:left-1/2 top-1/2 -translate-y-1/2 transform md:-translate-x-1/2 w-12 h-12 rounded-full bg-gradient-to-br ${item.color} shadow-2xl ${item.glowColor} flex items-center justify-center border-4 border-gray-900 z-10`}
//                   >
...
//                   className={`flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br ${skill.color} shadow-lg`}
//                 >
...
//           >
//             <div className="inline-block p-8 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-xl rounded-2xl border border-cyan-500/20">
