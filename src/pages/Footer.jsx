...
//     // Generate random stars with unique positions and depths
//     const stars = useMemo(() => {
...
//             <footer className="relative h-[70vh] w-full overflow-hidden bg-gradient-to-b from-gray-950 via-gray-950 to-slate-900">
//                 {/* Animated Starfield - Responds to Mouse */}
//                 {stars.map((star) => (
//                     <m.div
//                         key={star.id}
...
//                 {/* Orbiting Constellation Circles */}
//                 <m.div
...
//                 {/* Central Content - FIXED */}
//                 <div className="relative z-20 h-full flex items-center justify-center">
//                     <div className="text-center px-6 max-w-4xl">
//                         {/* Main Heading */}
//                         <h1 className="text-5xl sm:text-6xl my-4 lg:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500 drop-shadow-xl">
//                             PREM RAI
//                         </h1>
...
//                         {/* Social Links */}
//                         <m.p className="text-gray-400 mb-4 uppercase text-sm tracking-widest">
//                             Connect with me
//                         </m.p>
//                         <m.div
...
//                         {/* Copyright */}
//                         <m.p
//                             className="mt-8 text-sm text-gray-400 font-light tracking-wide"
//                             initial={{ opacity: 0 }}
//                             animate={{ opacity: 1 }}
