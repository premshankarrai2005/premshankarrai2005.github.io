...
//           >
//             <m.div className="flex justify-center items-center gap-4 mb-6">
//               <Mail className="w-12 h-12 text-cyan-400 flex-shrink-0 self-center" />
...
//             >
//               <div
//                 className="relative perspective-1000 rounded-3xl p-8 lg:p-12 border border-cyan-500/20 shadow-2xl backdrop-blur-xl bg-gradient-to-br from-gray-800/40 via-gray-900/40 to-gray-800/40"
//                 style={{
...
//                       ease: "easeInOut"
//                     }}
//                     className="inline-flex items-center justify-center w-24 h-24 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 shadow-lg"
//                   >
...
//                     </h3>
//                     <h3 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
//                       Meaningful
//                     </h3>
//                     <p className="text-gray-400 text-lg">
//                       Turn your ideas into reality with clean code and thoughtful design.
//                     </p>
//                   </div>
...
//                         className="group relative inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gray-800/50 border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300"
//                       >
...
//             >
//               <div className="relative backdrop-blur-xl bg-gradient-to-br from-gray-800/40 via-gray-900/40 to-gray-800/40 rounded-3xl p-8 lg:p-12 border border-gray-700/50 shadow-2xl">
...
//                       className="w-full px-4 py-3 rounded-xl bg-gray-900/50 border border-gray-700/50 text-white placeholder-gray-500
//                                  focus:outline-none focus:border-transparent focus:ring-2 focus:ring-cyan-500/50 transition-all duration-300"
//                     />
//                   </div>
...
//                       className="w-full px-4 py-3 rounded-xl bg-gray-900/50 border border-gray-700/50 text-white placeholder-gray-500
//                                  focus:outline-none focus:border-transparent focus:ring-2 focus:ring-cyan-500/50 transition-all duration-300 resize-none"
//                     />
//                   </div>
...
//                     whileTap={{ scale: 0.98 }}
//                     className={`relative w-full px-8 py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold
//               overflow-hidden group transition-all duration-300 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
//                   >
//                     <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-blue-400 opacity-0 group-hover:opacity-100
//                   transition-opacity duration-300" />
//                     <div
//                       className={`absolute inset-0 bg-white/20 rounded-full blur-xl transition-all duration-300 ${isHovered ? 'scale-150 opacity-100' : 'scale-0 opacity-0'
//                         }`}
//                     />
