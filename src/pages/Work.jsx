...
//               <Award className="w-12 h-12 text-cyan-400 flex-shrink-0 self-center" />
...
//                 className="flex items-center gap-3 px-6 py-3 rounded-lg font-semibold text-white
...
//                     className={`group flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'
//                       } gap-8 items-center`}
//                   >
//                     {/* Image */}
...
//                         <div>
//                           <h3 className="text-4xl lg:text-5xl font-bold text-white mb-4 transition-all duration-700
//                           group-hover:text-transparent group-hover:bg-gradient-to-r
//                           group-hover:from-cyan-400 group-hover:to-blue-400 group-hover:bg-clip-text">
//                             {project.title}
//                           </h3>
//                           <p className="text-gray-400 text-lg leading-relaxed transition-colors duration-500 group-hover:text-gray-300">
//                             {project.description}
//                           </p>
//                         </div>
...
//                             <span
//                               key={i}
//                               className="tag-float px-3 py-1.5 bg-gray-800 border border-gray-700 text-gray-300 text-xs font-semibold rounded-lg group-hover:border-cyan-500/80 group-hover:bg-gray-800/80 group-hover:text-cyan-300 transition-all duration-500"
